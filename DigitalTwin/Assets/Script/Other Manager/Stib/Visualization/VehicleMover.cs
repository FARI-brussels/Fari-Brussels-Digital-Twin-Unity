...
public class VehicleMoverStib : MonoBehaviour
{
    ...
    private float reachDistance = 0.5f; // Distance pour considérer un point atteint
    ...
    // Méthode pour reprendre le mouvement
    public void ResumeMoving()
    {
        isMoving = true;
    }

    // Méthode pour savoir si on a terminé le chemin
    public bool IsPathCompleted()
    {
        return !isMoving && currentPathIndex >= path.Count;
    }
}
